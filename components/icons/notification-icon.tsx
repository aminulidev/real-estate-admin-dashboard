...
export const NotificationIcon = () => {
    return (
        <div className="relative">
            <span className="absolute right-0 block h-2 w-2 bg-destructive rounded-full"></span>
            <svg className="w-8 h-8" width="40" height="40" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
